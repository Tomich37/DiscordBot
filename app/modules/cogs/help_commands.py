...
COMMANDS_INFO = {
    ...
    "play": {
        ...
        "details": [
            ...
            "Треки плейлиста сохраняются в БД и подготавливаются по одному перед проигрыванием, поэтому большой плейлист не блокирует старт музыки.",
        ],
        "admin_only": False,
    },
    "skip": {
    ...
    "stop": {
        ...
        "details": [
            ...
            "Если музыка сейчас играет, очищается плейлист пользователя, чей трек проигрывается.",
        ],
        "admin_only": False,
    },
    "pause": {
    ...
    "queue": {
        ...
        "params": [],
        "details": [
            "В сообщении показывается текущий трек, сколько треков осталось в вашем плейлисте и сколько недоступных треков было пропущено.",
        ],
        "admin_only": False,
    },
    "leave": {
