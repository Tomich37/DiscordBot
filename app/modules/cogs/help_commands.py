...
COMMANDS_INFO = {
    ...
    "play": {
        ...
        "category": "Музыка",
        "kind": "Слэш-команда",
        "short": "Включает музыку с YouTube или добавляет найденный трек в очередь.",
        "params": [
            ("query", "Ссылка на YouTube или обычный поисковый запрос."),
        ],
        "details": [
            "Перед запуском команды нужно зайти в голосовой канал.",
            "Бот подключится к вашему каналу, найдёт трек через YouTube и начнёт проигрывание через ffmpeg.",
    ...
    "stop": {
        ...
        "category": "Музыка",
        "kind": "Слэш-команда",
        "short": "Останавливает музыку и очищает очередь.",
        "params": [],
        "details": [
    ...
    "queue": {
        ...
        "category": "Музыка",
        "kind": "Слэш-команда",
        "short": "Показывает текущий трек и ближайшие треки в очереди.",
        "params": [],
        "details": [
            "В сообщении показываются текущий трек и первые 10 треков очереди.",
        ],
        "admin_only": False,
    },
    "leave": {
        ...
        "params": [],
        "details": [
            "После отключения очередь текущего сервера очищается.",
        ],
        "admin_only": False,
    },
}
